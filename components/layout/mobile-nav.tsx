...
export function MobileNav() {
  ...
  return (
    <nav className={cn('fixed inset-x-0 bottom-0 z-40 flex border-t backdrop-blur-md md:hidden', isMae ? 'border-info/25 bg-info/5' : 'border-border bg-surface/95')}>
      {NAV_ITEMS.map((item) => {
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active ? (isMae ? 'text-info' : 'text-accent') : 'text-muted-foreground'
            )}
          >
